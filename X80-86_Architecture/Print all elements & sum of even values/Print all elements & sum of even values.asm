...
msgB db 'Sum of even values:',13,10,'$'
...
l2:
    ...
    jnz skip_even
    cbw                 ; sign-extend AL -> AX (safe)
    add word ptr sum, ax ; (see note below)
skip_even:
    inc si
    loop l2
...
; Fast Print decimal AX using buffer (no push/pop loop)
PRINT_NUM proc
    push ax
    push bx
    push cx
